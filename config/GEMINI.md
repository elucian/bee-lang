# Gemini — Agent Instructions (adapter)

This is the Gemini-specific adapter in `config/`. Read `config/AGENTS.md` — it
is the canonical, single source of truth for AI-agent behavior in this
repository. The repository-root `GEMINI.md` is a discovery stub that hands off
